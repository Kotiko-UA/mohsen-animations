...
import Img from '../../../../assets/wes-img-1.jpg'
		...
		<div className='journey-modal-wrap'>
			...
			<div className='flex-col-24-40'>
				<p className='journey-modal-text'>
					...
					by step into the world of cryptocurrency and digital assets. The
					journey begins with the <span>Basic Level</span>, which introduces
					core concepts such as blockchain fundamentals, cryptocurrencies,
					wallets, exchanges, and security best practices through short,
					interactive, and easy-to-understand modules.
				</p>
