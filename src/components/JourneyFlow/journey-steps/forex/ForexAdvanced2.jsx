			...
			<div className='journey-modal-dis-sw'>
				<div className='flex-col-24'>
					...
					<div className='flex-col-12'>
						...
						<JourneyLinkButton
							link={
								'https://wowpowers.com/stream-player/nate/livestream/1e033a9f-1338-4b08-b22d-2a8a3fa64b4f?reference=TOP_EDUCATORS'
							}
				...
				<div className='flex-col-24'>
					...
					<div className='flex-col-12'>
						...
						<JourneyLinkButton
							link={
								'https://wowpowers.com/stream-player/reynaldo/livestream/cdbd577d-5132-41d9-a188-845afef4f31e'
							}
							className='journey-modal-assent-button'>
							Live Session
						</JourneyLinkButton>
				...
				<div className='flex-col-24'>
					...
					<div className='flex-col-12'>
						...
						<JourneyLinkButton
							link={
								'https://wowpowers.com/stream-player/giuliano/livestream/253eef6c-dff1-41cd-84aa-e32a1e6ac473'
							}
							className='journey-modal-assent-button'>
							Live Session
						</JourneyLinkButton>
